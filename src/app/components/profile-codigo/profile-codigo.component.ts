...
@Component({
  selector: 'app-profile-codigo',
  templateUrl: './profile-codigo.component.html',
  styleUrls: ['./profile-codigo.component.css'],
  providers: [UserService,AlumnoService]
})
export class ProfileCodigoComponent implements OnInit {
